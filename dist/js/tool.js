...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NestedDraggable__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NestedDraggable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__NestedDraggable__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    NestedDraggable: __WEBPACK_IMPORTED_MODULE_0__NestedDraggable___default.a
  },
  props: {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3af0d3bb"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/NestedDraggable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3af0d3bb", Component.options)
  } else {
    hotAPI.reload("data-v-3af0d3bb", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("42be0ab2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3af0d3bb\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NestedDraggable.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3af0d3bb\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NestedDraggable.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c(
    "draggable",
    {
      staticClass: "pb-1 mb-1 bg-gray",
      attrs: { tag: "ul", list: _vm.nav, group: { name: "g1" } }
    },
    _vm._l(_vm.nav, function(node, index) {
      return _c(
        "li",
        {
          key: index,
          on: {
            click: function($event) {
              ...
              return _vm.onClick(node)
            }
          }
        },
        [
          node.open ? _c("span", [_vm._v("-")]) : _c("span", [_vm._v("+")]),
          _vm._v("\n    " + _vm._s(node.name) + "\n    "),
          node.open
            ? _c("nested-draggable", { attrs: { nav: node.children } })
            : _vm._e()
        ],
        1
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3af0d3bb", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.nav ? _c("nested-draggable", { attrs: { nav: _vm.nav } }) : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "flex w-full justify-end mt-2" }, [
        _c(
          "button",
          {
            staticClass:
              "btn btn-default btn-icon bg-primary pull-right text-white",
